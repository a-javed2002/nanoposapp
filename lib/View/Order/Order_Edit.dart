...
import 'package:nano/Controller/OrdereEditController.dart';
// import 'package:nano/Controller/SummaryController.dart';
import 'package:nano/Controller/TableController.dart';
import 'package:nano/Model/OrderTable.dart' as orderController;
...
class OrderEdit extends StatefulWidget {
  String? tablename;
  int? tableId;
  final orderController.OrderTableModal? order;
...
class _OrderEditState extends State<OrderEdit> {
  ...
  Widget build(BuildContext context) {
    Get.delete<OrderEditController>();
    final OrderEditController controller =
        Get.put(OrderEditController(orderdata: widget.order));
                                ...
                                onPressed: () async {
                                  ...
                                  if (cartJson != null) {
                                    ...
                                    List<dynamic> jsonData =
                                        jsonDecode(cartJson);
                                    print(jsonData);
                                    List<orderController.Product> products =
                                        jsonData.map((item) {
                                      var product = item['product'];
                                      print(product['v_id']);
                                      return orderController.Product(
                                          id: product['id'],
                                    ...
                                    var newOrder =
                                        orderController.OrderTableModal(
                                      ...
                                      transaction_date: formattedDate, // Example value
                                      total_before_tax:
                                      ...
                                      rp_redeemed_amount:
                                          '0.0', // Example value
                                      shipping_charges: '0.0', // Example value
                                    ...
                                    if (newOrder.products.length > 0) {
                                      ...
                                      controller.cart.refresh();
                                      print(
                                          "update order ${newOrder.products.length}");
                                      Get.to(() => OrderPlaced(title: "Order Update",));
                                    } else {
  ...
  void _showAlreadyBookedAlert(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title:
              Text('Already Booked', style: GoogleFonts.poppins(fontSize: 26)),
