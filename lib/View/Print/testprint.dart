...
Future<void> printBill(
    {required OrderTableModal order, required String status, required bool finall}) async {
  ...
  bluetooth.isConnected.then((isConnected) {
    if (isConnected == true) {
      ...
      bluetooth.printNewLine();
      bluetooth.print3Column("", "Server:", order.staffName!, Size.bold.val);
      bluetooth.print3Column("Date & Time:", now.toString(), "", Size.bold.val);
      bluetooth.printNewLine();
      bluetooth.printCustom(status, Size.bold.val, Align.center.val);
      bluetooth.printNewLine();
      
      bluetooth.printCustom("Products", Size.bold.val, Align.left.val);
      bluetooth.printNewLine();
      ...
      bluetooth.printNewLine();
      bluetooth.paperCut(); // some printer not supported
    }
  });
}
